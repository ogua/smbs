     ...
     @endif
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="{{ admin_url('/') }}"><b>
                {{ admin_trans('formfields.parentlogin') }}
            </b></a>
            </div>
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    ...
                    <a class="btn btn-outline btn-info btn-block mb-2" href="/admin/auth/login">Main Login<a>
                    ...
                    <form action="{{ route('login-parent') }}" method="post">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control " placeholder="{{ admin_trans('formfields.studentid') }}"
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <div class="input-group mb-3">
                                <input type="password" class="form-control" placeholder="{{ trans('formfields.phonenumber') }}"
                                       name="password">
                                <div class="input-group-append">
                                    <div class="input-group-text">
